    ...
    %{
      ...
      checks: %{
        enabled: [
          ...
          {Credo.Check.Readability.Specs, [files: %{excluded: [~r"/priv/repo/migrations/"]}]},
          ...
          #
          ## ExDNA - AST-based code duplication detection
          #
          {ExDNA.Credo, []},

          #
          ## ExSlop - AI-generated code slop (30 high-signal checks)
          #
          ...
          # Opt-in checks not covered by built-in Credo
          # (UseMapJoin/CaseTrueFalse omitted - covered by Refactor.MapJoin/CaseTrivialMatches)
